import _SurfacePhysics
import f90wrap.runtime
import logging

class Surface_Physics(f90wrap.runtime.FortranModule):
    """
    ...
    class Surface_Param_Class(f90wrap.runtime.FortranDerivedType):
        ...
        def __init__(self, handle=None):
            ...
            self._handle = _SurfacePhysics.f90wrap_surface_param_class_initialise()
        ...
        def __del__(self):
            ...
            """
            if self._alloc:
                _SurfacePhysics.f90wrap_surface_param_class_finalise(this=self._handle)
        ...
        def name(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__name(self._handle)
        
        @name.setter
        def name(self, name):
            _SurfacePhysics.f90wrap_surface_param_class__set__name(self._handle, name)
        ...
        def boundary(self):
            ...
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_param_class__array__boundary(self._handle)
            if array_handle in self._arrays:
                boundary = self._arrays[array_handle]
            else:
                boundary = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_param_class__array__boundary)
        ...
        def alb_scheme(self):
            ...
            """
            return \
                _SurfacePhysics.f90wrap_surface_param_class__get__alb_scheme(self._handle)
        
        @alb_scheme.setter
        def alb_scheme(self, alb_scheme):
            _SurfacePhysics.f90wrap_surface_param_class__set__alb_scheme(self._handle, \
                alb_scheme)
        ...
        def nx(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__nx(self._handle)
        
        @nx.setter
        def nx(self, nx):
            _SurfacePhysics.f90wrap_surface_param_class__set__nx(self._handle, nx)
        ...
        def n_ksub(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__n_ksub(self._handle)
        
        @n_ksub.setter
        def n_ksub(self, n_ksub):
            _SurfacePhysics.f90wrap_surface_param_class__set__n_ksub(self._handle, n_ksub)
        ...
        def ceff(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__ceff(self._handle)
        
        @ceff.setter
        def ceff(self, ceff):
            _SurfacePhysics.f90wrap_surface_param_class__set__ceff(self._handle, ceff)
        ...
        def albi(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__albi(self._handle)
        
        @albi.setter
        def albi(self, albi):
            _SurfacePhysics.f90wrap_surface_param_class__set__albi(self._handle, albi)
        ...
        def albl(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__albl(self._handle)
        
        @albl.setter
        def albl(self, albl):
            _SurfacePhysics.f90wrap_surface_param_class__set__albl(self._handle, albl)
        ...
        def alb_smax(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__alb_smax(self._handle)
        
        @alb_smax.setter
        def alb_smax(self, alb_smax):
            _SurfacePhysics.f90wrap_surface_param_class__set__alb_smax(self._handle, \
                alb_smax)
        ...
        def alb_smin(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__alb_smin(self._handle)
        
        @alb_smin.setter
        def alb_smin(self, alb_smin):
            _SurfacePhysics.f90wrap_surface_param_class__set__alb_smin(self._handle, \
                alb_smin)
        ...
        def hcrit(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__hcrit(self._handle)
        
        @hcrit.setter
        def hcrit(self, hcrit):
            _SurfacePhysics.f90wrap_surface_param_class__set__hcrit(self._handle, hcrit)
        ...
        def rcrit(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__rcrit(self._handle)
        
        @rcrit.setter
        def rcrit(self, rcrit):
            _SurfacePhysics.f90wrap_surface_param_class__set__rcrit(self._handle, rcrit)
        ...
        def amp(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__amp(self._handle)
        
        @amp.setter
        def amp(self, amp):
            _SurfacePhysics.f90wrap_surface_param_class__set__amp(self._handle, amp)
        ...
        def csh(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__csh(self._handle)
        
        @csh.setter
        def csh(self, csh):
            _SurfacePhysics.f90wrap_surface_param_class__set__csh(self._handle, csh)
        ...
        def clh(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__clh(self._handle)
        
        @clh.setter
        def clh(self, clh):
            _SurfacePhysics.f90wrap_surface_param_class__set__clh(self._handle, clh)
        ...
        def tmin(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__tmin(self._handle)
        
        @tmin.setter
        def tmin(self, tmin):
            _SurfacePhysics.f90wrap_surface_param_class__set__tmin(self._handle, tmin)
        ...
        def tmax(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__tmax(self._handle)
        
        @tmax.setter
        def tmax(self, tmax):
            _SurfacePhysics.f90wrap_surface_param_class__set__tmax(self._handle, tmax)
        ...
        def tstic(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__tstic(self._handle)
        
        @tstic.setter
        def tstic(self, tstic):
            _SurfacePhysics.f90wrap_surface_param_class__set__tstic(self._handle, tstic)
        ...
        def tsticsub(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__tsticsub(self._handle)
        
        @tsticsub.setter
        def tsticsub(self, tsticsub):
            _SurfacePhysics.f90wrap_surface_param_class__set__tsticsub(self._handle, \
                tsticsub)
        ...
        def tau_a(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__tau_a(self._handle)
        
        @tau_a.setter
        def tau_a(self, tau_a):
            _SurfacePhysics.f90wrap_surface_param_class__set__tau_a(self._handle, tau_a)
        ...
        def tau_f(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__tau_f(self._handle)
        
        @tau_f.setter
        def tau_f(self, tau_f):
            _SurfacePhysics.f90wrap_surface_param_class__set__tau_f(self._handle, tau_f)
        ...
        def w_crit(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__w_crit(self._handle)
        
        @w_crit.setter
        def w_crit(self, w_crit):
            _SurfacePhysics.f90wrap_surface_param_class__set__w_crit(self._handle, w_crit)
        ...
        def mcrit(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__mcrit(self._handle)
        
        @mcrit.setter
        def mcrit(self, mcrit):
            _SurfacePhysics.f90wrap_surface_param_class__set__mcrit(self._handle, mcrit)
        ...
        def afac(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__afac(self._handle)
        
        @afac.setter
        def afac(self, afac):
            _SurfacePhysics.f90wrap_surface_param_class__set__afac(self._handle, afac)
        ...
        def tmid(self):
            ...
            """
            return _SurfacePhysics.f90wrap_surface_param_class__get__tmid(self._handle)
        
        @tmid.setter
        def tmid(self, tmid):
            _SurfacePhysics.f90wrap_surface_param_class__set__tmid(self._handle, tmid)
    ...
    class Surface_State_Class(f90wrap.runtime.FortranDerivedType):
        ...
        def __init__(self, handle=None):
            ...
            """
            f90wrap.runtime.FortranDerivedType.__init__(self)
            self._handle = _SurfacePhysics.f90wrap_surface_state_class_initialise()
        ...
        def __del__(self):
            ...
            """
            if self._alloc:
                _SurfacePhysics.f90wrap_surface_state_class_finalise(this=self._handle)
        ...
        def t2m(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__t2m(self._handle)
            if array_handle in self._arrays:
                t2m = self._arrays[array_handle]
            else:
                t2m = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__t2m)
        ...
        def tsurf(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__tsurf(self._handle)
            if array_handle in self._arrays:
                tsurf = self._arrays[array_handle]
            else:
                tsurf = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__tsurf)
        ...
        def hsnow(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__hsnow(self._handle)
            if array_handle in self._arrays:
                hsnow = self._arrays[array_handle]
            else:
                hsnow = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__hsnow)
        ...
        def hice(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__hice(self._handle)
            if array_handle in self._arrays:
                hice = self._arrays[array_handle]
            else:
                hice = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__hice)
        ...
        def alb(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__alb(self._handle)
            if array_handle in self._arrays:
                alb = self._arrays[array_handle]
            else:
                alb = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__alb)
        ...
        def alb_snow(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__alb_snow(self._handle)
            if array_handle in self._arrays:
                alb_snow = self._arrays[array_handle]
            else:
                alb_snow = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__alb_snow)
        ...
        def melt(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__melt(self._handle)
            if array_handle in self._arrays:
                melt = self._arrays[array_handle]
            else:
                melt = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__melt)
        ...
        def melted_snow(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__melted_snow(self._handle)
            if array_handle in self._arrays:
                melted_snow = self._arrays[array_handle]
            else:
                melted_snow = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__melted_snow)
        ...
        def melted_ice(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__melted_ice(self._handle)
            if array_handle in self._arrays:
                melted_ice = self._arrays[array_handle]
            else:
                melted_ice = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__melted_ice)
        ...
        def refr(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__refr(self._handle)
            if array_handle in self._arrays:
                refr = self._arrays[array_handle]
            else:
                refr = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__refr)
        ...
        def smb(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__smb(self._handle)
            if array_handle in self._arrays:
                smb = self._arrays[array_handle]
            else:
                smb = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__smb)
        ...
        def acc(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__acc(self._handle)
            if array_handle in self._arrays:
                acc = self._arrays[array_handle]
            else:
                acc = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__acc)
        ...
        def lhf(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__lhf(self._handle)
            if array_handle in self._arrays:
                lhf = self._arrays[array_handle]
            else:
                lhf = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__lhf)
        ...
        def shf(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__shf(self._handle)
            if array_handle in self._arrays:
                shf = self._arrays[array_handle]
            else:
                shf = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__shf)
        ...
        def lwu(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__lwu(self._handle)
            if array_handle in self._arrays:
                lwu = self._arrays[array_handle]
            else:
                lwu = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__lwu)
        ...
        def subl(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__subl(self._handle)
            if array_handle in self._arrays:
                subl = self._arrays[array_handle]
            else:
                subl = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__subl)
        ...
        def evap(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__evap(self._handle)
            if array_handle in self._arrays:
                evap = self._arrays[array_handle]
            else:
                evap = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__evap)
        ...
        def smb_snow(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__smb_snow(self._handle)
            if array_handle in self._arrays:
                smb_snow = self._arrays[array_handle]
            else:
                smb_snow = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__smb_snow)
        ...
        def smb_ice(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__smb_ice(self._handle)
            if array_handle in self._arrays:
                smb_ice = self._arrays[array_handle]
            else:
                smb_ice = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__smb_ice)
        ...
        def runoff(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__runoff(self._handle)
            if array_handle in self._arrays:
                runoff = self._arrays[array_handle]
            else:
                runoff = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__runoff)
        ...
        def qmr(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__qmr(self._handle)
            if array_handle in self._arrays:
                qmr = self._arrays[array_handle]
            else:
                qmr = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__qmr)
        ...
        def qmr_res(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__qmr_res(self._handle)
            if array_handle in self._arrays:
                qmr_res = self._arrays[array_handle]
            else:
                qmr_res = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__qmr_res)
        ...
        def sf(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__sf(self._handle)
            if array_handle in self._arrays:
                sf = self._arrays[array_handle]
            else:
                sf = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__sf)
        ...
        def rf(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__rf(self._handle)
            if array_handle in self._arrays:
                rf = self._arrays[array_handle]
            else:
                rf = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__rf)
        ...
        def sp(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__sp(self._handle)
            if array_handle in self._arrays:
                sp = self._arrays[array_handle]
            else:
                sp = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__sp)
        ...
        def lwd(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__lwd(self._handle)
            if array_handle in self._arrays:
                lwd = self._arrays[array_handle]
            else:
                lwd = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__lwd)
        ...
        def swd(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__swd(self._handle)
            if array_handle in self._arrays:
                swd = self._arrays[array_handle]
            else:
                swd = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__swd)
        ...
        def wind(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__wind(self._handle)
            if array_handle in self._arrays:
                wind = self._arrays[array_handle]
            else:
                wind = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__wind)
        ...
        def rhoa(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__rhoa(self._handle)
            if array_handle in self._arrays:
                rhoa = self._arrays[array_handle]
            else:
                rhoa = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__rhoa)
        ...
        def qq(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__qq(self._handle)
            if array_handle in self._arrays:
                qq = self._arrays[array_handle]
            else:
                qq = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__qq)
        ...
        def mask(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _SurfacePhysics.f90wrap_surface_state_class__array__mask(self._handle)
            if array_handle in self._arrays:
                mask = self._arrays[array_handle]
            else:
                mask = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _SurfacePhysics.f90wrap_surface_state_class__array__mask)
    ...
    class Boundary_Opt_Class(f90wrap.runtime.FortranDerivedType):
        ...
        def __init__(self, handle=None):
            ...
            """
            f90wrap.runtime.FortranDerivedType.__init__(self)
            self._handle = _SurfacePhysics.f90wrap_boundary_opt_class_initialise()
        ...
        def __del__(self):
            ...
            """
            if self._alloc:
                _SurfacePhysics.f90wrap_boundary_opt_class_finalise(this=self._handle)
        ...
        def t2m(self):
            ...
            """
            return _SurfacePhysics.f90wrap_boundary_opt_class__get__t2m(self._handle)
        
        @t2m.setter
        def t2m(self, t2m):
            _SurfacePhysics.f90wrap_boundary_opt_class__set__t2m(self._handle, t2m)
        ...
        def tsurf(self):
            ...
            """
            return _SurfacePhysics.f90wrap_boundary_opt_class__get__tsurf(self._handle)
        
        @tsurf.setter
        def tsurf(self, tsurf):
            _SurfacePhysics.f90wrap_boundary_opt_class__set__tsurf(self._handle, tsurf)
        ...
        def hsnow(self):
            ...
            """
            return _SurfacePhysics.f90wrap_boundary_opt_class__get__hsnow(self._handle)
        
        @hsnow.setter
        def hsnow(self, hsnow):
            _SurfacePhysics.f90wrap_boundary_opt_class__set__hsnow(self._handle, hsnow)
        ...
        def alb(self):
            ...
            """
            return _SurfacePhysics.f90wrap_boundary_opt_class__get__alb(self._handle)
        
        @alb.setter
        def alb(self, alb):
            _SurfacePhysics.f90wrap_boundary_opt_class__set__alb(self._handle, alb)
        ...
        def melt(self):
            ...
            """
            return _SurfacePhysics.f90wrap_boundary_opt_class__get__melt(self._handle)
        
        @melt.setter
        def melt(self, melt):
            _SurfacePhysics.f90wrap_boundary_opt_class__set__melt(self._handle, melt)
        ...
        def refr(self):
            ...
            """
            return _SurfacePhysics.f90wrap_boundary_opt_class__get__refr(self._handle)
        
        @refr.setter
        def refr(self, refr):
            _SurfacePhysics.f90wrap_boundary_opt_class__set__refr(self._handle, refr)
        ...
        def smb(self):
            ...
            """
            return _SurfacePhysics.f90wrap_boundary_opt_class__get__smb(self._handle)
        
        @smb.setter
        def smb(self, smb):
            _SurfacePhysics.f90wrap_boundary_opt_class__set__smb(self._handle, smb)
        ...
        def acc(self):
            ...
            """
            return _SurfacePhysics.f90wrap_boundary_opt_class__get__acc(self._handle)
        
        @acc.setter
        def acc(self, acc):
            _SurfacePhysics.f90wrap_boundary_opt_class__set__acc(self._handle, acc)
        ...
        def lhf(self):
            ...
            """
            return _SurfacePhysics.f90wrap_boundary_opt_class__get__lhf(self._handle)
        
        @lhf.setter
        def lhf(self, lhf):
            _SurfacePhysics.f90wrap_boundary_opt_class__set__lhf(self._handle, lhf)
        ...
        def shf(self):
            ...
            """
            return _SurfacePhysics.f90wrap_boundary_opt_class__get__shf(self._handle)
        
        @shf.setter
        def shf(self, shf):
            _SurfacePhysics.f90wrap_boundary_opt_class__set__shf(self._handle, shf)
        ...
        def subl(self):
            ...
            """
            return _SurfacePhysics.f90wrap_boundary_opt_class__get__subl(self._handle)
        
        @subl.setter
        def subl(self, subl):
            _SurfacePhysics.f90wrap_boundary_opt_class__set__subl(self._handle, subl)
    ...
    class Surface_Physics_Class(f90wrap.runtime.FortranDerivedType):
        ...
        def __init__(self, handle=None):
            ...
            """
            f90wrap.runtime.FortranDerivedType.__init__(self)
            self._handle = _SurfacePhysics.f90wrap_surface_physics_class_initialise()
        ...
        def __del__(self):
            ...
            """
            if self._alloc:
                _SurfacePhysics.f90wrap_surface_physics_class_finalise(this=self._handle)
        ...
        def par(self):
            ...
            """
            par_handle = \
                _SurfacePhysics.f90wrap_surface_physics_class__get__par(self._handle)
            if tuple(par_handle) in self._objs:
                par = self._objs[tuple(par_handle)]
            else:
                par = surface_physics.Surface_Param_Class.from_handle(par_handle)
        ...
        def par(self, par):
            par = par._handle
            _SurfacePhysics.f90wrap_surface_physics_class__set__par(self._handle, par)
        ...
        def bnd(self):
            ...
            """
            bnd_handle = \
                _SurfacePhysics.f90wrap_surface_physics_class__get__bnd(self._handle)
            if tuple(bnd_handle) in self._objs:
                bnd = self._objs[tuple(bnd_handle)]
            else:
                bnd = surface_physics.Boundary_Opt_Class.from_handle(bnd_handle)
        ...
        def bnd(self, bnd):
            bnd = bnd._handle
            _SurfacePhysics.f90wrap_surface_physics_class__set__bnd(self._handle, bnd)
        ...
        def bnd0(self):
            ...
            """
            bnd0_handle = \
                _SurfacePhysics.f90wrap_surface_physics_class__get__bnd0(self._handle)
            if tuple(bnd0_handle) in self._objs:
                bnd0 = self._objs[tuple(bnd0_handle)]
            else:
                bnd0 = surface_physics.Boundary_Opt_Class.from_handle(bnd0_handle)
        ...
        def bnd0(self, bnd0):
            bnd0 = bnd0._handle
            _SurfacePhysics.f90wrap_surface_physics_class__set__bnd0(self._handle, bnd0)
        ...
        def now(self):
            ...
            """
            now_handle = \
                _SurfacePhysics.f90wrap_surface_physics_class__get__now(self._handle)
            if tuple(now_handle) in self._objs:
                now = self._objs[tuple(now_handle)]
            else:
                now = surface_physics.Surface_State_Class.from_handle(now_handle)
        ...
        def now(self, now):
            now = now._handle
            _SurfacePhysics.f90wrap_surface_physics_class__set__now(self._handle, now)
        ...
        def mon(self):
            ...
            """
            mon_handle = \
                _SurfacePhysics.f90wrap_surface_physics_class__get__mon(self._handle)
            if tuple(mon_handle) in self._objs:
                mon = self._objs[tuple(mon_handle)]
            else:
                mon = surface_physics.Surface_State_Class.from_handle(mon_handle)
        ...
        def mon(self, mon):
            mon = mon._handle
            _SurfacePhysics.f90wrap_surface_physics_class__set__mon(self._handle, mon)
        ...
        def ann(self):
            ...
            """
            ann_handle = \
                _SurfacePhysics.f90wrap_surface_physics_class__get__ann(self._handle)
            if tuple(ann_handle) in self._objs:
                ann = self._objs[tuple(ann_handle)]
            else:
                ann = surface_physics.Surface_State_Class.from_handle(ann_handle)
        ...
        def ann(self, ann):
            ann = ann._handle
            _SurfacePhysics.f90wrap_surface_physics_class__set__ann(self._handle, ann)
    ...
    def surface_energy_and_mass_balance(self, par, bnd, day, year):
        ...
        """
        _SurfacePhysics.f90wrap_surface_energy_and_mass_balance(now=self._handle, \
    ...
    def energy_balance(self, par, bnd, day, year):
        ...
        """
        _SurfacePhysics.f90wrap_energy_balance(now=self._handle, par=par._handle, \
    ...
    def mass_balance(self, par, bnd, day, year):
        ...
        """
        _SurfacePhysics.f90wrap_mass_balance(now=self._handle, par=par._handle, \
            bnd=bnd._handle, day=day, year=year)
    ...
    def surface_physics_average(self, now, step, nt=None):
        ...
        """
        _SurfacePhysics.f90wrap_surface_physics_average(ave=self._handle, \
    ...
    def surface_alloc(self, npts):
        ...
        """
        _SurfacePhysics.f90wrap_surface_alloc(now=self._handle, npts=npts)
    ...
    def surface_dealloc(self):
        ...
        """
        _SurfacePhysics.f90wrap_surface_dealloc(now=self._handle)
    ...
    def surface_physics_par_load(self, filename):
        ...
        """
        _SurfacePhysics.f90wrap_surface_physics_par_load(par=self._handle, \
            filename=filename)
    ...
    def surface_boundary_define(self, boundary):
        ...
        """
        _SurfacePhysics.f90wrap_surface_boundary_define(bnd=self._handle, \
            boundary=boundary)
    ...
    def print_param(self):
        ...
        """
        _SurfacePhysics.f90wrap_print_param(par=self._handle)
    ...
    def print_boundary_opt(self):
        ...
        """
        _SurfacePhysics.f90wrap_print_boundary_opt(bnd=self._handle)
    ...
    def sigm(self):
        ...
        """
        return _SurfacePhysics.f90wrap_surface_physics__get__sigm()
    ...
    def eps(self):
        ...
        """
        return _SurfacePhysics.f90wrap_surface_physics__get__eps()
    ...
    def cls(self):
        ...
        """
        return _SurfacePhysics.f90wrap_surface_physics__get__cls()
    ...
    def clv(self):
        ...
        """
        return _SurfacePhysics.f90wrap_surface_physics__get__clv()
    ...
    def cap(self):
        ...
        """
        return _SurfacePhysics.f90wrap_surface_physics__get__cap()
    
    def __str__(self):
        ret = ['<surface_physics>{\n']
        ret.append('    sigm : ')
        ret.append(repr(self.sigm))
        ret.append(',\n    eps : ')
        ret.append(repr(self.eps))
        ret.append(',\n    cls : ')
        ret.append(repr(self.cls))
        ret.append(',\n    clv : ')
        ret.append(repr(self.clv))
        ret.append(',\n    cap : ')
        ret.append(repr(self.cap))
        ret.append('}')
        return ''.join(ret)
